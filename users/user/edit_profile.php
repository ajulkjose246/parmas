                            ...
                            <div class="bg-secondary-soft px-4 py-5 rounded">
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="email" name="email" id="email" class="form-control" placeholder="" aria-label="Phone number" value="<?= $user['usr_email'] ?>" required>
                                    </div>
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        <label class="form-label">Password </label> <label class="form-label error" id="pwd_error"></label>
