                                ...
                                <div class="row g-3">
                                    <div class="text-center">
                                        <div class="square position-relative display-2 mb-3">
                                            <img id="img_upld"
                                                src="/parmas/assets/img/profile/<?= $user['usr_profile'] ?>">
                        ...
                        <div class="col-xxl-8 mb-5 mb-xxl-0">
                            <div class="bg-secondary-soft px-4 py-5 rounded">
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        <label class="form-label">First Name </label> <label class="form-label error"
                                            id="f_error"></label>
                                        <input type="text" name="fname" id="fname" class="form-control" placeholder=""
                                            aria-label="First name" value="<?= $user['usr_fname'] ?>" required>
                                    </div>
                                    <div class="col-md-6">
                                        <label class="form-label">Last Name </label> <label class="form-label error"
                                            id="s_error"></label>
                                        <input type="text" name="sname" id="sname" class="form-control"
                                            aria-label="Last name" value="<?= $user['usr_sname'] ?>" required>
                                    </div>
                                    <div class="col-md-6">
                                        <label class="form-label">Phone number </label> <label class="form-label error"
                                            id="p_error"></label>
                                        <input type="text" name="phone" id="phone" class="form-control" placeholder=""
                                            aria-label="Phone number" value="<?= $user['usr_phone'] ?>" required>
                                    </div>
                                    <div class="col-md-6">
                                        <label class="form-label">Email </label> <label class="form-label error"
                                            id="e_error"></label>
                                        <input type="email" name="email" id="email" class="form-control" placeholder=""
                                            aria-label="Phone number" value="<?= $user['usr_email'] ?>" required>
                                    </div>
                                    <div class="col-md-6">
                                        <label for="inputEmail4" class="form-label">House Name </label> <label
                                            class="form-label error" id="h_error"></label>
                                    ...
                                    <div class="col-md-6">
                                        <label for="inputEmail4" class="form-label">Baptism Name </label> <label
                                            class="form-label error" id="bap_error"></label>
                                    ...
                                    <div class="col-md-6">
                                        <label for="inputEmail4" class="form-label">Family Unit </label> <label
                                            class="form-label error" id="ward_error"></label>
                                    ...
                                    <div class="col-md-6">
                                        <label class="form-label">Password </label> <label class="form-label error"
                                            id="pwd_error"></label>
