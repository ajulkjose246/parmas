                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class=" mb-4">
                                                <select class="form-control" name="position" required>
                                                    ...
                                                    <?php
                                                    $sql = "SELECT * FROM `tbl_administration_position` WHERE `pos_status`=0 ";
                                            ...
                                            <div class=" mb-4">
                                                <input type="submit" name="subBtn" id="subBtn" class="form-control btn-primary"
                                                    value="Submit" >
                                            </div>
                                        </div>
                                    </form>
                                        ...
                                        <table style="width: 100%;border-collapse:separate;border-spacing:0 15px;">
                                            ...
                                            while ($row = mysqli_fetch_array($result)) {
                                                ...
                                                <tr>
                                                    ...
                                                    <?php if($row['usr_position'] != 2){?>
                                                        <td><a href="remove_administration_member.php?id=<?= $row['id'] ?>&pos_id=<?=$row['usr_position'] ?>"
