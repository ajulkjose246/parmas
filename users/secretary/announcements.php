...
if ($usr_status == 2) {
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            <h1 class="h3 mb-0 text-gray-800  fw-bolder">Announcements</h1>
                            ...
                            <div class="col-lg-6 mb-4">
                                ...
                                <div class="card shadow mb-4">
                                    <div class="card-header py-3">
                                        <h6 class="m-0 font-weight-bold text-primary">Upload Announcements</h6>
                                    </div>
                                    <form action="#" method="post" enctype="multipart/form-data">
                                        <div class="card-body">
                                            ...
                                            <div class=" mb-4">
                                                <textarea name="content" id="" class="form-control"  rows="2" required></textarea>
                                            </div>
                                    ...
                                    <form action="#" method="post" enctype="multipart/form-data">
                                        <div class="card-body">
                                            <table style="width: 100%;border-collapse:separate;border-spacing:0 15px;">
                                                ...
                                                <?php
                                                $sql = "SELECT * FROM `tbl_announcement` WHERE  `status` = 1";
                                                $result = mysqli_query($con, $sql);
                                                while ($row = mysqli_fetch_array($result)) { ?>
                                                    <tr>
                                                        <td><?= $row['content'] ?></td>
                                                        <td><a href="/parmas/assets/img/announcement/<?= $row['image'] ?>" target="_blank"><img src="/parmas/assets/img/announcement/<?= $row['image'] ?>"
                                                                alt="" style="width: 43px;height: 43px;"></a></td>
                                                        <td><a href="remove_announcement.php?id=<?= $row['id'] ?>"
    ...
    if (isset($_POST['subBtn'])) {
        ...
        $sql = "INSERT INTO `tbl_announcement`(`content`, `image`) VALUES ('$content','$image')";
        mysqli_query($con, $sql);
        $targetdir = "../../assets/img/announcement/";
        $file_path = $targetdir . basename($image);
        move_uploaded_file($_FILES['image']['tmp_name'], $file_path);
        $yourURL = "announcements.php";
